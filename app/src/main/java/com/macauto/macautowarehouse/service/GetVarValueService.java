...
public class GetVarValueService extends IntentService {
    ...
    private static final String METHOD_NAME = "get_var_value"; // 方法名稱

    private static final String SOAP_ACTION1 = "http://tempuri.org/get_var_value"; // SOAP_ACTION

    private static final String URL = "http://172.17.17.244:8484/service.asmx"; // 網址

    public GetVarValueService() {
        super("GetVarValueService");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            request.addProperty("tag_id", tag_id);
