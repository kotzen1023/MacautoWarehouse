...
public class GetTTSplitRvvItemService extends IntentService {
    public static final String TAG = "SplitRvvItemService";
    ...
    private static final String METHOD_NAME = "Get_TT_split_rvv_item"; // 方法名稱

    private static final String SOAP_ACTION1 = "http://tempuri.org/Get_TT_split_rvv_item"; // SOAP_ACTION
    ...
    public GetTTSplitRvvItemService() {
        super("GetTTSplitRvvItemService");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getAction() != null) {
            if (intent.getAction().equals(Constants.ACTION.ACTION_GET_TT_SPLIT_RVV_ITEM_ACTION)) {
                Log.i(TAG, "ACTION_GET_TT_SPLIT_RVV_ITEM_ACTION");
            }
        }
        ...
        if (dataTable_Batch_area != null) {
            ...
            try {
                ...
                if (envelope.bodyIn instanceof SoapFault) {
                    ...
                    is_split_success = parseToBoolean(resultsRequestSOAP);


                    if (is_split_success) {
                        intent = new Intent(Constants.ACTION.ACTION_GET_TT_SPLIT_RVV_ITEM_SUCCESS);
                        sendBroadcast(intent);
                    } else {
                        intent = new Intent(Constants.ACTION.ACTION_GET_TT_SPLIT_RVV_ITEM_FAILED);
                        sendBroadcast(intent);
                    }
            ...
            Log.e(TAG, "dataTable_Batch_area = null");
        }
    }
