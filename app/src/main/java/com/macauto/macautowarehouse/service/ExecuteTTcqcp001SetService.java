...
public class ExecuteTTcqcp001SetService extends IntentService {
    public static final String TAG = "ExecuteTTcqcp";
    ...
    private static final String METHOD_NAME = "Execute_TT_cqcp001_Set"; // 方法名稱

    private static final String SOAP_ACTION1 = "http://tempuri.org/Execute_TT_cqcp001_Set"; // SOAP_ACTION
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getAction() != null) {
            if (intent.getAction().equals(Constants.ACTION.ACTION_RECEIVING_INSPECTION_EXECUTE_TT_OQCP_ACTION)) {
                Log.i(TAG, "ACTION_RECEIVING_INSPECTION_EXECUTE_TT_OQCP_ACTION");
            }
        }
        ...
        if (dataTable_YIC != null && dataTable_YIC.Rows.size() > 0) {
            ...
            try {
                ...
                if (envelope.bodyIn instanceof SoapFault) {
                    ...
                    if (!is_success) {
                        checkResultIntent = new Intent(Constants.ACTION.ACTION_RECEIVING_INSPECTION_EXECUTE_TT_OQCP_FAILED);

                    } else {
                        checkResultIntent = new Intent(Constants.ACTION.ACTION_RECEIVING_INSPECTION_EXECUTE_TT_OQCP_SUCCESS);
                ...
                e.printStackTrace();
                Intent getFailedIntent = new Intent(Constants.ACTION.ACTION_RECEIVING_INSPECTION_EXECUTE_TT_OQCP_FAILED);
