...
public class GetDeptNoService extends IntentService {
    public static final String TAG = "GetDeptNoService";
    ...
    private static final String METHOD_NAME = "Get_dept_no"; // 方法名稱

    private static final String SOAP_ACTION1 = "http://tempuri.org/Get_dept_no"; // SOAP_ACTION

    private static final String URL = "http://172.17.17.244:8484/service.asmx"; // 網址

    public GetDeptNoService() {
        super("GetDeptNoService");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getAction() != null) {
            if (intent.getAction().equals(Constants.ACTION.ACTION_ALLOCATION_GET_DEPT_NO_ACTION)) {
                Log.i(TAG, "ACTION_ALLOCATION_GET_DEPT_NO_ACTION");
            }
        }
        ...
        try {
            ...
            request.addProperty("emp_no", emp_no);
            ...
            if (envelope.bodyIn instanceof SoapFault) {
                ...
                if (ret != null) {
                    Intent getSuccessIntent = new Intent(Constants.ACTION.ACTION_ALLOCATION_GET_DEPT_NO_SUCCESS);
                    getSuccessIntent.putExtra("DEPT_NO", ret);
                    sendBroadcast(getSuccessIntent);
                } else {
                    Intent getFailedIntent = new Intent(Constants.ACTION.ACTION_ALLOCATION_GET_DEPT_NO_FAILED);
