...
public class DeleteTTReceiveGoodsReportDataQCTempService extends IntentService {
    public static final String TAG = "DeleteGoodsQCTemp";
    ...
    private static final String METHOD_NAME = "Delete_TT_ReceiveGoods_report_Data_QC_Temp"; // 方法名稱

    private static final String SOAP_ACTION1 = "http://tempuri.org/Delete_TT_ReceiveGoods_report_Data_QC_Temp"; // SOAP_ACTION
    ...
    public DeleteTTReceiveGoodsReportDataQCTempService() {
        super("DeleteTTReceiveGoodsReportDataQCTempService");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getAction() != null) {
            if (intent.getAction().equals(Constants.ACTION.ACTION_RECEIVING_INSPECTION_DELETE_QC_TEMP_ACTION)) {
                Log.i(TAG, "ACTION_RECEIVING_INSPECTION_DELETE_QC_TEMP_ACTION");
            }
        }
        ...
        try {
            ...
            if (envelope.bodyIn instanceof SoapFault) {
                ...
                intent = new Intent(Constants.ACTION.ACTION_RECEIVING_INSPECTION_DELETE_QC_TEMP_SUCCESS);
                sendBroadcast(intent);
            }
            ...
            e.printStackTrace();
            intent = new Intent(Constants.ACTION.ACTION_RECEIVING_INSPECTION_DELETE_QC_TEMP_FAILED);
            sendBroadcast(intent);
