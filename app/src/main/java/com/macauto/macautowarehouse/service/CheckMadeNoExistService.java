...
public class CheckMadeNoExistService extends IntentService {
    ...
    private static final String METHOD_NAME = "Check_made_no_exist"; // 方法名稱

    private static final String SOAP_ACTION1 = "http://tempuri.org/Check_made_no_exist"; // SOAP_ACTION
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getAction() != null) {
            if (intent.getAction().equals(Constants.ACTION.ACTION_ALLOCATION_SEND_MSG_CHECK_MADE_NO_EXIST_ACTION)) {
                Log.i(TAG, "ACTION_ALLOCATION_SEND_MSG_CHECK_MADE_NO_EXIST_ACTION");
            }
        }
        ...
        try {
            ...
            if (envelope.bodyIn instanceof SoapFault) {
                ...
                Intent getSuccessIntent = new Intent(Constants.ACTION.ACTION_ALLOCATION_SEND_MSG_CHECK_MADE_NO_EXIST_FAILED);
            ...
            e.printStackTrace();
            Intent getFailedIntent = new Intent(Constants.ACTION.ACTION_ALLOCATION_SEND_MSG_CHECK_MADE_NO_EXIST_FAILED);
