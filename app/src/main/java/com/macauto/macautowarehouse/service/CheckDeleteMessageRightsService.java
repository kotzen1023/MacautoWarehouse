...
public class CheckDeleteMessageRightsService extends IntentService {
    ...
    private static final String METHOD_NAME = "Check_delete_message_rights"; // 方法名稱

    private static final String SOAP_ACTION1 = "http://tempuri.org/Check_delete_message_rights"; // SOAP_ACTION
    //normal port 8000, test port 8484
    //private static final String URL = "http://172.17.17.244:"+web_soap_port+"/service.asmx"; // 網址

    public CheckDeleteMessageRightsService() {
        super("CheckDeleteMessageRightsService");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getAction() != null) {
            if (intent.getAction().equals(Constants.ACTION.ACTION_ALLOCATION_CHECK_IS_DELETE_RIGHT_ACTION)) {
                Log.i(TAG, "ACTION_ALLOCATION_CHECK_IS_DELETE_RIGHT_ACTION");
            }
        }
