...
public class GetReceiveGoodsInDataAXService extends IntentService {
    public static final String TAG = "GetReceiveAXService";
    ...
    private static final String METHOD_NAME = "Get_TT_ReceiveGoods_IN_Data_AX"; // 方法名稱

    private static final String SOAP_ACTION1 = "http://tempuri.org/Get_TT_ReceiveGoods_IN_Data_AX"; // SOAP_ACTION
    //normal port 8000, test port 8484
    //private static final String URL = "http://172.17.17.244:"+web_soap_port+"/service.asmx"; // 網址

    public GetReceiveGoodsInDataAXService() {
        super("GetReceiveGoodsInDataAXService");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String item_no_list = intent.getStringExtra("ITEM_NO_LIST");
        ...
        Log.e(TAG, "item_no_list = "+item_no_list);
        ...
        try {
            ...
            request.addProperty("item_no_list", item_no_list);
            request.addProperty("check_sp", check_sp);
            request.addProperty("org_item_no", item_no);
            ...
            if (envelope.bodyIn instanceof SoapFault) {
                ...
                SoapObject s_deals = (SoapObject) resultsRequestSOAP.getProperty("Get_TT_ReceiveGoods_IN_Data_AXResult");
                    ...
                    if (dataTable.Rows.size() == 0) {
                        ...
                        for (int i=0; i < dataTable.Rows.size(); i++) {
                            ...
                            /*for (int j=0; j < dataTable.Columns.size(); j++) {
                                ...
                                } else if (j==12) { //rvv33_scan
                                    item.setTitle(this.getResources().getString(R.string.item_title_rvv33_scan));
                                }
